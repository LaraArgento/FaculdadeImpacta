...
Ela recebe um número e retorna a soma de todos os numeros inteiros até
ele
por exemplo, soma_n_primeiros(3) retorna 6 (que é 1+2+3)
por exemplo, soma_n_primeiros(5) retorna 15 (que é 1+2+3+4+5)
por exemplo, soma_n_primeiros(100) retorna 5050 (que é
1+2+3+4+5...+99+100)
...
O primeiro teste pega o "caso simples": listas com 0 ou 1 elemento
Depois de passar ele, implemente a recursao usando as duas ideias
abaixo
...
(ou seja, 'a'+umastring+'a' é palindromo quando umastring é
palindromo)
...
Ou seja, uma lista de listas pode conter listas que também contem
listas:
[[[[[1]]],2]] é uma lista de listas válida
Para ajudar, escrevi uma funcao eh_lista que retorna True se um objeto
é lista e
False se não é
'''
def eh_lista(a):
...
'''
Escreva uma funcao soma_ll que recebe uma lista de listas e retorna a
soma de
todos os números
...
class TestStringMethods(unittest.TestCase):
 ...
 self.assertEqual(filtro_recursivo([0,1,2,1,4],5),
[0,1,2,1,4])
 ...
 self.assertEqual(troca_recursiva([0,1,2,1,4],1,7),
[0,7,2,7,4])
 self.assertEqual(troca_recursiva([0,1,2,1,4],4,9),
[0,1,2,1,9])
 self.assertEqual(troca_recursiva([1,1],1,2), [2,2])
 self.assertEqual(troca_recursiva([1,1],2,7), [1,1])
 self.assertEqual(troca_recursiva([0,1,2,1,4],5,3),
[0,1,2,1,4])
 self.assertEqual(troca_recursiva([0,1,2,1,4],0,0),
[0,1,2,1,4])
 self.assertEqual(troca_recursiva([0,1,2,1,4],9,9),
[0,1,2,1,4])
 ...
 a = anagramas('abc')
 self.assertEqual(set(a),set(['abc', 'acb', 'bac', 'bca',
'cab', 'cba']))
 a = anagramas('abcd')
 self.assertEqual(set(a),set(['abcd', 'abdc', 'acbd', 'acdb',
'adbc', 'adcb', 'bacd', 'badc', 'bcad', 'bcda', 'bdac', 'bdca',
'cabd', 'cadb', 'cbad', 'cbda', 'cdab', 'cdba', 'dabc', 'dacb',
'dbac', 'dbca', 'dcab', 'dcba']))
 a = anagramas('abca')
 self.assertEqual(set(a),set(['abca', 'abac', 'acba', 'acab',
'aabc', 'aacb', 'baca', 'baac', 'bcaa', 'bcaa', 'baac', 'baca',
'caba', 'caab', 'cbaa', 'cbaa', 'caab', 'caba', 'aabc', 'aacb',
'abac', 'abca', 'acab', 'acba']))
